 ...
 * @LastEditors: sam.li
 * @LastEditTime: 2021-05-08 16:32:28
 */
 ...
 * @return: 
 */
export const back = (options={ delta : 1}) =>{
    options.delta = parseInt(options.delta);
    console.log(`当前路由栈深度:${Taro.getCurrentPages().length},返回层级:[${options.delta}]`);
